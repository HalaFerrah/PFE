...
async function simulate() {
  ...
  try {
    ...
    document.getElementById('r-tva').textContent      = fmt(d.taxe_7pct || d.tva);
    document.getElementById('r-total').textContent    = fmt(d.prime_totale_ttc || d.total_general);
